...
namespace DebugMod
{
    public static class Console
    {
        ...
        {
            panel = new CanvasPanel(canvas, GUIController.Instance.images["ConsoleBg"], new Vector2(1275f, 750f), Vector2.zero, new Rect(0, 0, GUIController.Instance.images["ConsoleBg"].width, GUIController.Instance.images["ConsoleBg"].height));
